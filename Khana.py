...
def main_apv():
    ...
    try:
        ...
        os.system('am start https://wa.me/+9203171753731?text=' + tks)

        

    r1=requests.get("https://github.com/Zohaib75612/Khana/blob/main/Khan.txt").text
    ...
    if key1 in r1:
        ...
        os.system('am start https://wa.me/+923171753731?text=' + tks)
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/Khan-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/Khan-CP.txt' % (H, P, str(len(cp))))
...
def R():
			...
			print ("\033[1m [!] Tool    : Muhammad ZOHAIB")
